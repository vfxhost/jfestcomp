...
class ProjectController extends FormController
{
    ...
    protected function allowAdd($data = [])
    {
        ...
        // Access check.
        $access = $user->authorise('project.access', 'com_festival');
        if (!$access) {
            return \false;
        }
    ...
    protected function allowEdit($data = [], $key = 'id')
    {
        ...
        if ($recordId) {
            ...
            $permission = $user->authorise('core.edit', 'com_festival.project.' . (int) $recordId);
            if (!$permission) {
                if ($user->authorise('core.edit.own', 'com_festival.project.' . $recordId)) {
                    ...
                    if ($ownerId == $user->id) {
                        if ($user->authorise('core.edit.own', 'com_festival')) {
                            return \true;
                        }
                    }
                }
    ...
    public function batch($model = \null)
    {
        ...
        // Preset the redirect
        $this->setRedirect(Route::_('index.php?option=com_festival&view=projecs' . $this->getRedirectToListAppend(), \false));
    ...
    public function cancel($key = \null)
    {
        ...
        if (!\is_null($return) && Uri::isInternal(\base64_decode($return))) {
            ...
            $this->setRedirect(Route::_('index.php?option=' . $this->option . $redirect, \false));
        } elseif ($this->ref) {
