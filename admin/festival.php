...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_festival'))
{
...
$document->addStyleSheet('components/com_festival/assets/css/admin.css');
$document->addScript('components/com_festival/assets/js/admin.js');
